 ...
 * because the screen is this mod's own and has no library that could be missing. If the flipper is absent nothing
 ...
 * names no ModMenu type. {@link ConfigScreen} is only reached after the hub has
 * decided to open this mod.
 *
